...
/// <summary>
/// In-memory fake of <see cref="IFtpBrowseApi"/> for unit and integration testing.
/// Supports canned responses, error simulation, and call tracking.
/// </summary>
public class FakeFtpBrowseApi : IFtpBrowseApi
{
    ...
    public FakeFtpBrowseApi AddBrowseResponse(Guid gameServerId, string path, FtpDirectoryListingDto dto)
    {
    ...
    public FakeFtpBrowseApi SetDefaultBehavior(DefaultBehavior behavior)
    {
